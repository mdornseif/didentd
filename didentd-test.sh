#!/bin/sh
# $Id: didentd-test.sh,v 1.1 2001/10/11 15:38:56 drt Exp $
# basic tests
export KEY=test
export GID=0
export PROTO=TCP
...
echo "8192 , 4096" | env UID=0 /home/drt/didentd/didentd 2> test.2 > test.crypt
echo "8192 , 4096" | env UID=0 /home/drt/didentd/didentd-static 2>> test.2 >> test.1
echo "8192 , 4096" | env UID=0 /home/drt/didentd/didentd-name 2>> test.2 >> test.1
